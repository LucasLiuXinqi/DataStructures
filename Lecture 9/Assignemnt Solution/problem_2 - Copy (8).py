...
class LinkedBinaryTree(BinaryTree):
    ...
    def _swap(self, e, q):
        ...
        node_p_right = node_e._right

        node_q_left = node_q._left
        node_q_right = node_q._right

        node_e._parent = node_q_parent if node_q_parent != node_e else node_q
        node_q._parent = node_e_parent if node_e_parent != node_q else node_e
        node_e._left = node_q_left if node_q_left != node_e else node_q

        try:
            if node_e_left != node_q:
                node_e_left._parent = node_q
        except Exception:
            pass
        node_e._right = node_q_right if node_q_right != node_e else node_q
        ...
        try:
            ...
            pass
        node_q._left = node_e_left if node_e_left != node_q else node_e

        try:
            if node_q_left != node_e:
                node_q_left._parent = node_e
        except Exception:
            pass
        node_q._right = node_p_right if node_p_right != node_q else node_e

        try:
            if node_q_right != node_e:
                node_q_right._parent = node_e
        except Exception:
            pass

        try:
            if node_e_parent is None or node_q_parent is None:
                if node_e_parent is None:
