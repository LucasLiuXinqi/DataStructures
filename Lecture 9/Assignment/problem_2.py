...
class LinkedBinaryTree(BinaryTree):
    ...
    def _swap(self, e, q):
        ...
        e_parent = node_e._parent
        q_parent = node_q._parent

        e_left = node_e._left
        e_right = node_e._right

        q_left = node_q._left
        q_right = node_q._right
        ...
        if node_q == e_left:
            node_q._left = node_e
            node_e._left = q_left
            node_e._right = q_right
            node_q._right = e_right

            node_q._parent = e_parent
            node_e._parent = node_q

        elif node_q == e_right:
            node_q._right = node_e
            node_e._left = q_left
            node_e._right = q_right
            node_q._left = e_left
            ...
            node_e._parent = q_parent
            node_q._parent = node_e

        elif node_e == q_right:
            node_e._right = node_q
            node_q._left = e_left
            node_q._right = e_right
            node_e._left = q_left
        ...
        elif e_parent == q_parent:
            if e_parent._left == node_e:
                e_parent._left = node_q
                e_parent._right = node_e

            else:
                e_parent._right = node_q
                e_parent._left = node_e
            ...
            node_e._parent = node_q._parent = e_parent
            ...
            if q_parent._left == node_q:
                q_parent._left = node_e
            else:
                q_parent._right = node_e



        if self._root == node_e:
            self._root = node_q
        ...
        # parent_e = node_e._parent
        # parent_q = node_q._parent
        #
        # if parent_e == None:
        #     self._root = node_q
        # elif parent_e._left == node_e:
        ...
        #     left_e._parent = node_q
        # if left_q is not None:
        #     left_q._parent = node_e
        #
        # node_e._left, node_q._left = left_q, left_e
        #
        #
        # right_e = node_e._right
        # right_q = node_q._right
        #
        # if right_e is not None:
        #     right_e._parent = node_q
        # if right_q is not None:
        #     right_q._parent = node_e
        #
        # node_e._right, node_q._right = right_q, right_e
...
def main():
    ...
    id_left_old = id(left)
    id_right_old = id(right)

    print(left.element())
    print(right.element())

    tree._swap(left, right)  # swap left and right node

    id_left_new = id(left)
    id_right_new = id(right)

    print(left.element())
    print(right.element())

    print(id_left_new == id_right_old and id_right_new == id_left_old)  # should print true
